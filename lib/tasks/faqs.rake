namespace :birs do
  ...
  task birs_faqs: :environment do
    faqs = [
      {
        question: '<div data-controller="faqs"><h3 id="asked_to_complete"><a href="faqs#asked_to_complete" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Why am I being asked to complete the Diversity and Inclusivity Survey?' + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="required_to_complete"><a href="faqs#required_to_complete" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Who is required to complete the Diversity and Inclusivity Survey?' + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="impact_the_outcomes"><a href="faqs#impact_the_outcomes" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'As an organizer, will my answers impact the outcomes of the proposal, or any future proposals?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="next_steps"><a href="faqs#next_steps" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'I do not want to answer these questions. What are my next steps?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="anonymous_or_confidential"><a href="faqs#anonymous_or_confidential" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Are my answers anonymous or confidential?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="data_stored_securely"><a href="faqs#data_stored_securely" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'How is my data stored securely?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="changes_to_my_questionnaire"><a href="faqs#changes_to_my_questionnaire" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + "Can I make changes to my questionnaire after it has been completed and submitted?"  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="fill_in_questionnaire"><a href="faqs#fill_in_questionnaire" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'How do I fill in the questionnaire? How will I know that the questionnaire has been completed?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="demographics_of_organizers"><a href="faqs#demographics_of_organizers" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Why do you want to know about the demographics of your organizers and participants?'  + '</h3></div>',
        answer: 'BIRS is committed to providing a welcoming environment to all participants at BIRS events. It is our goal to host workshops that are demographically diverse, and to foster opportunities for career growth and development that are inclusive to all.
								The collection of information from our participants is one way that BIRS supports this goal. This information enables us to see trends, improvements, and shortfalls in the diversity of our participants. Ultimately it provides data that can be used for evidence-based decision-making to promote greater inclusion and diversity within mathematics.
      ...
      {
        question: '<div data-controller="faqs"><h3 id="filled_this_before"><a href="faqs#filled_this_before" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'I’ve filled this out before, why am I being asked to complete it again?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="self_identification_approach"><a href="faqs#self_identification_approach" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Why did you choose these questions? Why take a self-identification approach?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="more_than_one_group"><a href="faqs#more_than_one_group" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Can I identify in more than one group?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="mean_by_gender"><a href="faqs#mean_by_gender" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'What do you mean by “gender”?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="mean_by_2SLGBTQIA+"><a href="faqs#mean_by_2SLGBTQIA+" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'What do you mean by 2SLGBTQIA+?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="indigenous_person"><a href="faqs#indigenous_person" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'What do you mean by Indigenous person?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="disability_count"><a href="faqs#disability_count" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'Does my disability count?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="support_my_attendance"><a href="faqs#support_my_attendance" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'I have a disability, impairment, or ongoing medical condition that might impact my participation. How can BIRS support my attendance?'  + '</h3></div>',
      ...
      {
        question: '<div data-controller="faqs"><h3 id="under_represented_minority"><a href="faqs#under_represented_minority" data-action="mouseup->faqs#copy"><i class="align-middle me-2 fas fa-fw fa-link"></i></a>' + 'What is an under-represented minority (URM)?'   + '</h3></div>',
