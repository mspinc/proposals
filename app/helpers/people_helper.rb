module PeopleHelper
  ...
  def country_options
    countries = [
                ...
                %w[Afghanistan Afghanistan], %w[Albania Albania], %w[Algeria Algeria], %w[Andorra Andorra],
                 ...
                 ['Czechia (Czech Republic)', 'Czechia (Czech Republic)'], ['Democratic Republic of the Congo', 'Democratic Republic of the Congo'],
                 ...
                 %w[Palau Palau], ['Palestine State', 'Palestine State'], %w[Panama Panama], ['Papua New Guinea', 'Papua New Guinea'],
                 %w[Paraguay Paraguay], %w[Peru Peru], %w[Philippines Philippines], %w[Poland Poland], %w[Portugal Portugal],
                 ...
                 ['San Marino', 'San Marino'], ['Sao Tome and Principe', 'Sao Tome and Principe'], ['Saudi Arabia', 'Saudi Arabia'],
                 %w[Senegal Senegal], %w[Serbia Serbia], %w[Seychelles Seychelles], ['Sierra Leone', 'Sierra Leone'],
                 ...
                 ['South Sudan', 'South Sudan'], %w[Spain Spain], ['Sri Lanka', 'Sri Lanka'], %w[Sudan Sudan], %w[Suriname Suriname],
                 ...
                 ['Trinidad and Tobago', 'Trinidad and Tobago'], %w[Tunisia Tunisia], %w[Turkey Turkey], %w[Turkmenistan Turkmenistan],
                 %w[Tuvalu Tuvalu], %w[Uganda Uganda], %w[Ukraine Ukraine], ['United Arab Emirates', 'United Arab Emirates'],
  ...
  def country_canada_options
    country_canada = [%w[Alberta Alberta], ['British Columbia', 'British Columbia'], %w[Manitoba Manitoba], %w[Ontario Ontario],
                      ['New Brunswick', 'New Brunswick'], ['Newfoundland and Labrador', 'Newfoundland and Labrador'],
                      ['Northwest Territories', 'Northwest Territories'], ['Nova Scotia', 'Nova Scotia'], %w[Nunavut Nunavut],
                      ['Prince Edward Island', 'Prince Edward Island'], %w[Quebec Quebec], %w[Saskatchewan Saskatchewan], %w[Yukon Yukon]]
    country_canada.map { |disp, _value| disp }
  end

  def country_united_states_of_america_options
    country_united_states_of_america = [%w[Alabama Alabama], %w[Alaska Alaska], %w[Arizona Arizona], %w[Arkansas Arkansas], %w[California California],
                                        %w[Colorado Colorado], %w[Connecticut Connecticut], %w[Delaware Delaware], %w[Florida Florida],
                                        %w[Georgia Georgia], %w[Hawaii Hawaii], %w[Idaho Idaho], %w[Illinois Illinois], %w[Indiana Indiana],
                                        ...
                                        %w[Guam Guam], ['Northern Mariana Islands', 'Northern Mariana Islands'], ['Puerto Rico', 'Puerto Rico'],
